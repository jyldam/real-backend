    ...
    public function run(): void
    {
        $this->housingService->create(new HousingCreateData(
            ...
            characteristics: CharacteristicData::collection(items: [
                ...
                new CharacteristicData(characteristicId: 4, value: 40),
                new CharacteristicData(characteristicId: 5, value: 10),
                new CharacteristicData(characteristicId: 6, value: 2021),
                new CharacteristicData(characteristicId: 7, value: 'test'),
            ]),
            moderate: true,
            employeeId: 1
        ));
